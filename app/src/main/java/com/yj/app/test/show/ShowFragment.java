...
public class ShowFragment extends BaseFragment implements OnClickListener {
  ...
  public boolean onRiggerBackPressed(){
    ...
    Log.i("___boylab>>>___", "onBackPressed: tag = "+fragmentTAG);
    /*Fragment fragment = Rigger.getRigger(this).findFragmentByTag(getFragmentTag());
    Rigger.getRigger(this).close(fragment);*/
